...
private:
  ...
  bool get_ebreak() const {
    ...
    uint64_t get_clocks() {
#ifdef AXI_BUS
        return device_->Vortex_axi->vortex->vlSymsp->TOP__Vortex_axi__vortex__genblk2__BRA__0__KET____DOT__cluster__genblk2__BRA__0__KET____DOT__core__pipeline__execute.csr_unit->csr_data->csr_cycle;
#else
        return device_->Vortex->vlSymsp->TOP__Vortex__genblk2__BRA__0__KET____DOT__cluster__genblk2__BRA__0__KET____DOT__core__pipeline__execute.csr_unit->csr_data->csr_cycle;
#endif
    }

    uint64_t get_instrs() {
#ifdef AXI_BUS
        return device_->Vortex_axi->vortex->vlSymsp->TOP__Vortex_axi__vortex__genblk2__BRA__0__KET____DOT__cluster__genblk2__BRA__0__KET____DOT__core__pipeline__execute.csr_unit->csr_data->csr_instret;
#else
        return device_->Vortex->vlSymsp->TOP__Vortex__genblk2__BRA__0__KET____DOT__cluster__genblk2__BRA__0__KET____DOT__core__pipeline__execute.csr_unit->csr_data->csr_instret;
#endif
    }
